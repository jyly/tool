...
def create_siamese_network(input_shape):
	...
	base_network = simplemoel(input_shape)
...
train_data,val_data, train_target, val_target = train_test_split(train_pairs,train_label,test_size = 0.2,random_state = 30,stratify=train_label)
...
history=model.fit([train_data[:, 0], train_data[:, 1]], train_target,
          batch_size=128,
          epochs=epochs,verbose=2,
          validation_data=([val_data[:, 0], val_data[:, 1]], val_target))
